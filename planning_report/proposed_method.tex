...
Since camera is assumed to be calibrated each pixel is associated with an \gls{AOA}. The distance to pixels can be estimated by using algorithms like SGM \cite{hirschmuller2005accurate}.
